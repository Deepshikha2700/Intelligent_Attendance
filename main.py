...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'deepshikha2700@gmail.com' ")
...
window.configure(background='#ffa64d')

frame1 = tk.Frame(window, bg="#804000")
frame1.place(relx=0.11, rely=0.17, relwidth=0.39, relheight=0.80)

frame2 = tk.Frame(window, bg="#804000")
...
datef = tk.Label(frame4, text = day+"-"+mont[month]+"-"+year+"  |  ", fg="#c7a598",bg="#262523" ,width=57 ,height=1,font=('times', 22, ' bold '))
...
head2 = tk.Label(frame2, text="                       For New Registrations                       ", fg="black",bg="#c7a598" ,font=('times', 17, ' bold ') )
head2.grid(row=0,column=0)

head1 = tk.Label(frame1, text="                       For Already Registered                       ", fg="black",bg="#c7a598" ,font=('times', 17, ' bold ') )
head1.place(x=0,y=0)
